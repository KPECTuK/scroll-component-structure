...
{
	public class OneItemHopCoDirectionCarrier<TData> : CarrierBase<TData>
	{
		...
		public OneItemHopCoDirectionCarrier(IScrollController<TData> controller)
		{
			...
			if(first == null)
				return;
			first.RectTransform.GetIntersectionInParentSpace(new Straight { Direction = -controller.GrowDirection }, out _path);
		}
